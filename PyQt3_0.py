...
janela.resize(450, 450) # Aumentei um pouco a altura para caber os dois preço se nn ia ficar feio
...
# Ajustado para suportar duas linhas de texto do real e do dolar
...
def buscar():
    ...
    try:
        # Alterado: Adicionado 'usd' na consulta vs_currencies pra poder puxar o dolar
        ...
        if moeda in dados:
            ...
            # Formatação com as duas moedas juntas
